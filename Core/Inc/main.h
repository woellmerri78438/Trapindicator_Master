...
#define GSM_RSTPin_Pin GPIO_PIN_0
#define GSM_RSTPin_GPIO_Port GPIOA
...
#define GSM_Switch_Pin GPIO_PIN_9
#define GSM_Switch_GPIO_Port GPIOA
#define LPUART_TXPin_Pin GPIO_PIN_1
#define LPUART_TXPin_GPIO_Port GPIOC
#define LPUART_RXPin_Pin GPIO_PIN_0
#define LPUART_RXPin_GPIO_Port GPIOC
#define UARTGSM_RXPin_Pin GPIO_PIN_3
#define UARTGSM_RXPin_GPIO_Port GPIOA
#define UARTGSM_TXPin_Pin GPIO_PIN_2
#define UARTGSM_TXPin_GPIO_Port GPIOA
